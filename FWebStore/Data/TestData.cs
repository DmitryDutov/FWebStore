...
namespace FWebStore.Data
{
    public static class TestData
    {
        ...
        {
            new Employee{Id = 1, LastName = "L1", FirstName = "F1",Patronumic = "P1", Age = 34, Order = 1},
            new Employee{Id = 2, LastName = "L2", FirstName = "F2",Patronumic = "P2", Age = 35, Order = 2},
            new Employee{Id = 3, LastName = "L3", FirstName = "F2",Patronumic = "P3", Age = 36, Order = 3},
        };
